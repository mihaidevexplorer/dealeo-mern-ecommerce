  ...
  return (
    <div className="w-full mx-auto px-8 xl:px-6 lg:px-5 md-lg:px-4 md:px-4 sm:px-3 xs:px-2 2xs:px-2 py-10 xl:py-9 lg:py-9 md:py-8 sm:py-8 xs:py-7 2xs:py-6">
      <div className="mx-auto w-full max-w-screen-2xl">
        ...
        <div className="<div className="grid grid-cols-4 xl:grid-cols-4 lg:grid-cols-3 md-lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 xs:grid-cols-1 2xs:grid-cols-1 gap-4 xl:gap-5 md:gap-4 sm:gap-4 xs:gap-3 2xs:gap-3">
">
          {products.map((p) => (
            <div
              key={p._id}
