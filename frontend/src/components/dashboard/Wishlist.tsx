          ...
          return (
            ...
            >
              ...
              <div className='relative aspect-square overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100'>
                ...
                {/* Quick Actions Overlay - Doar pe desktop mare */}
                <div className='absolute inset-x-0 bottom-0 p-3 md:p-2 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 xl:hidden lg:hidden md-lg:hidden md:hidden sm:hidden xs:hidden 2xs:hidden'>
