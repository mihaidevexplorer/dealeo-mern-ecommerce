...
const SearchProducts: React.FC = () => {
  ...
  const renderRatingFilter = (stars: number, label: string, value: RatingFilter) => {
    return (
      <div 
              ...
              <div className='pl-8 md:pl-0'>
                ...
                <div className='py-4 bg-white mb-10 px-3 rounded-md flex justify-between items-start border shadow-sm'>
                  <h2 className='text-lg font-medium text-gray-900'>
                    ...
                    {searchValue && (
                      <span className='text-gray-600 ml-2'>for "<span className='font-semibold'>{searchValue}</span>"</span>
                    )}
                  </h2>
