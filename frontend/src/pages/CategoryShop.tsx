      ...
      <section className='py-16 lg:py-14 md:py-12 sm:py-10 xs:py-9 2xs:py-8'>
        <div className='w-[85%] lg:w-[90%] md:w-[92%] sm:w-[94%] xs:w-[96%] 2xs:w-[96%] h-full mx-auto'>
          ...
          <div className='w-full flex flex-wrap'>
            <div
              className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 md:pr-0 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0'}`}
            >
              ...
              <div className='py-3 flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-3'>
                  <div onClick={() => setRating('5')} className='text-orange-500 flex justify-start items-start gap-2 text-xl sm:text-lg xs:text-base cursor-pointer'>
                  ...
                  <div onClick={() => setRating('4')} className='text-orange-500 flex justify-start items-start gap-2 text-xl sm:text-lg xs:text-base cursor-pointer'>
                    <span><AiFillStar /></span>
                    <span><AiFillStar /></span>
                    <span><AiFillStar /></span>
                    <span><AiFillStar /></span>
                  ...
                  <div onClick={() => setRating('3')} className='text-orange-500 flex justify-start items-start gap-2 text-xl sm:text-lg xs:text-base cursor-pointer'>
                    <span><AiFillStar /></span>
                    <span><AiFillStar /></span>
                    <span><AiFillStar /></span>
                    <span><CiStar /></span>
                  ...
                  <div onClick={() => setRating('2')} className='text-orange-500 flex justify-start items-start gap-2 text-xl sm:text-lg xs:text-base cursor-pointer'>
                    <span><AiFillStar /></span>
                    <span><AiFillStar /></span>
                    <span><CiStar /></span>
                    <span><CiStar /></span>
                  ...
                  <div onClick={() => setRating('1')} className='text-orange-500 flex justify-start items-start gap-2 text-xl sm:text-lg xs:text-base cursor-pointer'>
                    <span><AiFillStar /></span>
                    <span><CiStar /></span>
                    <span><CiStar /></span>
                    <span><CiStar /></span>
                  ...
                  <div onClick={resetRating} className='text-orange-500 flex justify-start items-start gap-2 text-xl sm:text-lg xs:text-base cursor-pointer'>
                    <span><CiStar /></span>
                    <span><CiStar /></span>
                    <span><CiStar /></span>
                    <span><CiStar /></span>
...
export default CategoryShop; // modificat
