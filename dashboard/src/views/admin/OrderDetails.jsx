//src\views\admin\OrderDetails.jsx
...
const OrderDetails = () => {
    ...
    <div className='w-[70%]'>
        <div className='pl-3'>
            <div className='mt-4 flex flex-col bg-blue-500 rounded-md p-4'>
...

            {
                ...
                {
                    o.products?.map((p,i) =>  <div key={p.id || i}  className='flex gap-3 text-md mt-2'>
                    <img className='w-[50px] h-[50px]' src={p.images[0]} alt="" />
