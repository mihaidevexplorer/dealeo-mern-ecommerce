...
const Products = () => {
    ...
    return (
        <div className="px-2 lg:px-7 pt-5">
            <h1 className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500 font-bold text-xl mb-5">All Products</h1>
                            ...
                            {products.map((d, i) => (
                                <tr key={i} className="border-b bg-gray-700 border-gray-600 hover:bg-gray-600">
                                    ...
                                    <td className="py-2 px-4 text-gray-100">
                                        {d.discount === 0 ? (
                                            <span className="italic text-gray-400">No Discount</span>
                                        ) : (
                                            <span className="text-green-400 font-semibold">%{d.discount}</span>
                                        )}
                                    </td>
