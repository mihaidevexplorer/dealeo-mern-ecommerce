    ...
    <form onSubmit={add}>
        <div className='flex flex-col mb-3 md:flex-row gap-4 w-full text-[#FFF]'>
            <div className='flex flex-col w-full gap-1'>
                ...
                <input className='px-4 py-2 focus:border-blue-500 outline-none bg-[#FFF] border border-gray-600 rounded-md text-[#000]' onChange={inputHandle} value={state.name} type="text" name='name' id='name' placeholder='Product Name' />
            </div>  

            <div className='flex flex-col w-full gap-1'>
                <label htmlFor="brand">Product Brand</label>
                <input className='px-4 py-2 focus:border-blue-500 outline-none bg-[#FFF] border border-gray-600 rounded-md text-[#000]' onChange={inputHandle} value={state.brand} type="text" name='brand' id='brand' placeholder='Brand Name' />
            </div>   
        ...
        <div className='flex flex-col mb-3 md:flex-row gap-4 w-full text-[#FFF]'>
            <div className='flex flex-col w-full gap-1 relative'>
                ...
                <input readOnly onClick={()=> setCateShow(!cateShow)} className='px-4 py-2 focus:border-blue-500 outline-none bg-[#CCC] border border-gray-600 rounded-md text-[#000] cursor-pointer' onChange={inputHandle} value={category} type="text" id='category' placeholder='--select category--' />
            ...
            <div className='flex flex-col w-full gap-1'>
                ...
                <input className='px-4 py-2 focus:-blue-500 outline-none bg-[#FFF] border border-gray-600 rounded-md text-[#000]' onChange={inputHandle} value={state.stock} type="text" name='stock' id='stock' placeholder='Stock' />
            </div>   
        ...
        <div className='flex flex-col mb-3 md:flex-row gap-4 w-full text-[#FFF]'>
            <div className='flex flex-col w-full gap-1'>
                ...
                <input className='px-4 py-2 focus:border-blue-500 outline-none bg-[#FFF] border border-gray-600 rounded-md text-[#000]' onChange={inputHandle} value={state.price} type="number" name='price' id='price' placeholder='price' />
            </div>  

            <div className='flex flex-col w-full gap-1'>
                <label htmlFor="discount">Discount</label>
                <input className='px-4 py-2 focus:border-blue-500 outline-none bg-[#FFF] border border-gray-600 rounded-md text-[#000]' onChange={inputHandle} value={state.discount} type="number" name='discount' id='discount' placeholder='discount by %' />
            </div>   
